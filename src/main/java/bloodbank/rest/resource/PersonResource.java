...
public class PersonResource {
	...
	@RolesAllowed({ADMIN_ROLE })
	@Path( "/{id}")
	public Response updatePerson(  @PathParam( RESOURCE_PATH_ID_ELEMENT) int id,Person updatePerson) {
		Response response = null;
		Person newPersonWithIdTimestamps = service.updatePersonById( id,updatePerson);
		
		// For some reason, method below is throwing exception
